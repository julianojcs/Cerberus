...
const config: ExpoConfig = {
  ...
  extra: {
    ...
    // Credencial estática do broker (HiveMQ Cloud, MVP). Sem estas, o app
    // apresenta o JWT ao broker (username 'jwt' + token) — modelo on-prem
    // EMQX/Mosquitto. Ver src/services/mqtt.ts.
